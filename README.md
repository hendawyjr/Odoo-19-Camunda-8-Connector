...
Download the latest releases from the [Releases](https://github.com/your-org/camunda-odoo-connector/releases) page.

### Option 2: Build from Source

```bash
# Clone the repository
git clone https://github.com/your-org/camunda-odoo-connector.git
...
- 🐛 [Issue Tracker](https://github.com/your-org/camunda-odoo-connector/issues)
